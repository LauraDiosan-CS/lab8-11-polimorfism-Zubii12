...
void TestRepositoryFileCSV::teste(){
	Serializer<Comanda*>* serializer = new SerializerComanda;
	IRepository<Comanda*>* repo = new RepositoryFileCSV<Comanda*>("TestComanda.csv", serializer);
...
void TestRepositoryFileCSV::runTeste(){
	std::cout << " TESTE RepositoryFileCSV . . . ";
	teste();
